  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="grid grid-cols-3 overflow-auto">
        ...
        <div className="col-start-3 flex flex-col gap-7 items-start p-4">
          <h3 className="text-xl font-bold">타이포그래피</h3>
          <p className="w-max-[20rem] break-keep">제목용으로는 비주얼팀에서 제작한 서체를 사용하였습니다.</p>
          <p className="w-max-[20rem] break-keep">본문용 서체는 비주얼팀에서 사용한 누타입의 유료 폰트 'NU 시야'의 대용으로 류양희 디자이너의 휴머니스트 산세리프 한글서체 '고운 돋움'의 장평을 가독성을 해치지 않을 만큼만 줄여 사용했습니다.</p>
